            ...
            <div className='p-5 m-5 col-span-9 bg-[#F5FCFF] font-poppins'>
              ...
              <div className='mt-3'>
                ...
                <div className='flex items-center w-3/4'>
                  <input id='namaLengkap' type="text" className='p-2 mt-2 w-full block bg-white border border-slate-300 rounded-sm text-sm shadow-sm
                  placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500' placeholder='tempat'/>
                  <i className='fa-solid fa-calendar-days mx-4 text-xl text-gray-700'></i>
                  <input id='namaLengkap' type="date" className='p-2 mt-2 w-full block bg-white border border-slate-300 rounded-sm text-sm shadow-sm
              ...
              <div className='mt-3'>
                <div className='flex items-center w-3/4'>
                  ...
                  <input id='suluk' type="number" className='p-2 mt-2 w-full block bg-white border border-slate-300 rounded-sm text-sm shadow-sm
                  ...
                  <select id="kaji" className="p-2 mt-2 block w-3/4 bg-white border border-slate-300 rounded-sm text-sm shadow-sm
                placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500'">
                  <option className="text-xs" selected>Semua</option>
              ...
              <div>
                <button className='bg-blue-700 p-2 rounded-md text-white mt-9 w-3/4'>Simpan</button>
              </div>
            </div>
          </div>
      </div>
