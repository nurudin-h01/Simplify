...
export default function FilterKelasSaya() {
  ...
  return (
    <div className="h-max m-5 col-span-3 text-[#272837] p-6 bg-white border border-gray-200 rounded-lg shadow">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="focus:ring-green-500 focus:border-green-500">
        <div className="mb-3">
          <label for="jeniskelamin" class="block mb-1 text-xs text-gray-900">Status</label>
          <select {...register("jeniskelamin")} id="jeniskelamin"className="form-select appearance-none block w-full px-3 py-1.5 text-xs font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-[#272837] focus:outline-none">
            ...
            <option className="text-xs" value="Diterima">Diterima</option>
            <option className="text-xs" value="Ditolak">Ditolak</option>
            <option className="text-xs" value="Diproses">Diproses</option>
            <option className="text-xs" value="Konfirmasi">Konfirmasi</option>
            <option className="text-xs" value="Selesai">Selesai</option>
          </select>
        </div>
        <div className="mb-3">
      ...
      <p className="text-basea7YZ text-start font-bold mt-5 mb-3">Keterangan</p>
      <div className="flex space-x-2 mt-2">
        <div><div className="p-3 bg-blue-600 rounded-sm"></div></div>
        <p className="text-xs font-poppins">Pendaftaran masih di proses</p>
      </div>
      <div className="flex space-x-2 mt-2">
        <div><div className="p-3 bg-red-600 rounded-sm"></div></div>
        <p className="text-xs font-poppins">Tidak diterima</p>
      </div>
      <div className="flex space-x-2 mt-2">
        <div><div className="p-3 bg-yellow-500 rounded-sm"></div></div>
        <p className="text-xs font-poppins">Diterima di kelas namun harus konfirmasi kehadiran terlebih dahulu sebelum pelaksanaan</p>
      </div>
      <div className="flex space-x-2 mt-2">
        <div><div className="p-3 bg-green-600 rounded-sm"></div></div>
        <p className="text-xs font-poppins">Berhasil melakukan konfirmasi</p>
      </div>
      <div className="flex space-x-2 mt-2">
        <div><div className="p-3 bg-gray-700 rounded-sm"></div></div>
        <p className="text-xs font-poppins">Kelas yang telah selesai diikuti</p>
      </div>
    </div>
  );
}
