        ...
        <div className="col-span-11 pl-1 w-full">
          <div className="flex w-full">
            <div className="box-1 w-full">
              <p className="text-lg font-extrabold text-[#464646] mb-2">
                {namakelas}
              </p>
            </div>
            <div className="box-2 ml-auto flex flex-col text-[#464646]">
              <i class="fa-regular fa-bookmark text-[#464646] ml-auto"></i>
            </div>
          </div>
          <div className="my-2">
              <div className="grid grid-cols-12">
                <div className="col-span-4">
                  <div className="flex my-1">
                    <i class="fa-solid text-base fa-location-dot text-[#7A7A7A]"></i>
                    <p className="ml-2 mb-2 font-medium text-base text-[#7A7A7A]">
                      Lokasi{" "}
                    </p>
                  </div>
                  <div className="flex my-1">
                    <i class="fa-regular fa-calendar text-base text-[#7A7A7A]"></i>
                    <p className="ml-2 font-medium text-base text-[#7A7A7A]">
                      Pelaksanaan
                    </p>
                  </div>
                </div>
